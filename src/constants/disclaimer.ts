export const DisclaimerText = {
  rus: 'Ты живешь и не задумываешься о том, сколько еще осталось. Ты думаешь, что так будет продолжаться если не вечно, то еще очень долго. Иногда, чтобы в полную силу осознать что-либо, необходимо посмотреть на это со стороны. Я предлагаю взглянуть на то, сколько тебе осталось. Надеюсь, это заставит задуматься о том, как и на что ты тратишь самое дорогое, что есть у тебя в жизни - время.',
